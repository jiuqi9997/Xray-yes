...
finish() {
	...
	echo ""
	echo -e "$Red Share link: $Font vless://$uuid@$xray_domain:$port?flow=xtls-rprx-direct&encryption=none&security=xtls&type=tcp&headerType=none#$server_ip" | tee -a $info_file
	echo ""
